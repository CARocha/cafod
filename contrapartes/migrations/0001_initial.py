...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('contrapartes_contraparte', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('logo', self.gf('thumbs.ImageWithThumbsField')(max_length=100, null=True, blank=True)),
            ...
            ('temas', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('generalidades', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
