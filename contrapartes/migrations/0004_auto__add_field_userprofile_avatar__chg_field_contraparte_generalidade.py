...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('contrapartes_userprofile', 'avatar',
                      self.gf('thumbs_logo.ImageWithThumbsField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Contraparte.generalidades'
        db.alter_column('contrapartes_contraparte', 'generalidades', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Contraparte.temas'
        db.alter_column('contrapartes_contraparte', 'temas', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Contraparte.logo'
        db.alter_column('contrapartes_contraparte', 'logo', self.gf('thumbs_logo.ImageWithThumbsField')(max_length=100, null=True))
    def backwards(self, orm):
        # Deleting field 'UserProfile.avatar'
        db.delete_column('contrapartes_userprofile', 'avatar')


        # Changing field 'Contraparte.generalidades'
        db.alter_column('contrapartes_contraparte', 'generalidades', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Contraparte.temas'
        db.alter_column('contrapartes_contraparte', 'temas', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Contraparte.logo'
        db.alter_column('contrapartes_contraparte', 'logo', self.gf('thumbs.ImageWithThumbsField')(max_length=100, null=True))
    models = {
        'auth.group': {
