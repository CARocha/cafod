...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contraparte.user'
        db.delete_column('contrapartes_contraparte', 'user_id')

    def backwards(self, orm):
        # Adding field 'Contraparte.user'
        db.add_column('contrapartes_contraparte', 'user',
    ...
    models = {
        ...
        'contrapartes.contraparte': {
            ...
            'generalidades': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('thumbs.ImageWithThumbsField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'temas': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        'contrapartes.pais': {
