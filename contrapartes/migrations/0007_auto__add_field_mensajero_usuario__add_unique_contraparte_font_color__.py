...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mensajero.usuario'
        db.add_column('contrapartes_mensajero', 'usuario',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Contraparte', fields ['font_color']
        db.create_unique('contrapartes_contraparte', ['font_color'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Contraparte', fields ['font_color']
        db.delete_unique('contrapartes_contraparte', ['font_color'])

        # Deleting field 'Mensajero.usuario'
        db.delete_column('contrapartes_mensajero', 'usuario')
