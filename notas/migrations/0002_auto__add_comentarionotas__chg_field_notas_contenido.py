...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notas_comentarionotas', (
            ...
            ('fecha', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 5, 3, 0, 0))),
        ...
        # Changing field 'Notas.contenido'
        db.alter_column('notas_notas', 'contenido', self.gf('ckeditor.fields.RichTextField')())
    def backwards(self, orm):
        ...
        # Changing field 'Notas.contenido'
        db.alter_column('notas_notas', 'contenido', self.gf('django.db.models.fields.TextField')())
    models = {
        'auth.group': {
        ...
        'notas.comentarionotas': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 3, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nota': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['notas.Notas']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'notas.notas': {
            'Meta': {'object_name': 'Notas'},
