...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contraparte.telefono'
        db.alter_column('contrapartes_contraparte', 'telefono', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Contraparte.telefono'
        db.alter_column('contrapartes_contraparte', 'telefono', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'contrapartes.mensajero': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 11, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
