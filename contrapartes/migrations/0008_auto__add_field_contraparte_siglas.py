...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contraparte.siglas'
        db.add_column('contrapartes_contraparte', 'siglas',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Contraparte.siglas'
        db.delete_column('contrapartes_contraparte', 'siglas')
    ...
    models = {
        ...
        'contrapartes.mensajero': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 4, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
